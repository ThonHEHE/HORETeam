...
<body>
    ...
    <div class="banner">
        ...
        <div class="page-heading-shows-events position-relative bg-image-full"
            style="background-image: url(../event/assets/imgg/EventArt/artt.jpeg);">
                                            ...
                                            <div class="col-lg-9">
                                                <div class="row">
                                                    ...
                                                    $sql = "SELECT * FROM event 
                                                            ...
                                                            WHERE event.status = 'accept' AND event.status_waktu = 'upcoming' AND kategori_event.nama_kategori = 'art'";
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9">
                                                <div class="row">
                                                    ...
                                                    $sql = "SELECT * FROM event 
                                                            JOIN kategori_event ON event.id_kategori = kategori_event.id
                                                            WHERE event.status = 'accept' AND event.status_waktu = 'past' AND kategori_event.nama_kategori = 'art'";
