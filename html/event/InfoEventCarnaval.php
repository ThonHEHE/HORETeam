                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <?php
                                                    ...
                                                    $sql = "SELECT * FROM event 
                                                            ...
                                                            WHERE event.status = 'accept' AND event.status_waktu = 'upcoming' AND kategori_event.nama_kategori = 'Carnival'";
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <?php
                                                    ...
                                                    $sql = "SELECT * FROM event 
                                                            JOIN kategori_event ON event.id_kategori = kategori_event.id
                                                            WHERE event.status = 'accept' AND event.status_waktu = 'past' AND kategori_event.nama_kategori = 'Carnival'";
