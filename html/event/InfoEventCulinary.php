...
<body>
    ...
    <div class="banner">
        ...
        <div class="page-heading-shows-events position-relative bg-image-full"
            style="background-image: url(../event/assets/imgg/EventCulinary/cul.jpeg);">
            <div class="position-absolute top-0 start-0 end-0 bottom-0" style="background-color: rgba(0, 0, 0.8);">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2>Event Culinary</h2>
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <?php
                                                    ...
                                                    $sql = "SELECT * FROM event 
                                                            ...
                                                            WHERE event.status = 'accept' AND event.status_waktu = 'upcoming' AND kategori_event.nama_kategori = 'Culinary'";
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9">
                                                <div class="row">
                                                    ...
                                                    $sql = "SELECT * FROM event 
                                                            JOIN kategori_event ON event.id_kategori = kategori_event.id
                                                            WHERE event.status = 'accept' AND event.status_waktu = 'past' AND kategori_event.nama_kategori = 'Culinary'";
